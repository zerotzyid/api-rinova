...
// Try to extract the packed parameters
...
if (match) {
  ...
  console.log('first 50 keys:', keys.slice(0,50));
  let out = p;
  for (let i = a - 1; i >= 0; i--) {
    if (keys[i]) {
